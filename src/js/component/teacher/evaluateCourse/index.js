...
import {Button,Table,Row,InputNumber,Modal} from 'antd';
...
class EvaluateCourse extends React.Component{
    ...
    showCourseTaskModalOfSingleStudent(e){
        ...
        let teacherScore=e.target.getAttribute('data-teacher-score')||e.target.parentNode.getAttribute('data-teacher-score');
        ...
        this.setState({taskListModalVisible:true,taskListModalTitle:courseName,studentId:studentId,teacherScore:teacherScore});
    }
    ...
    render() {
        const columnsOfStudentScore = [{
            ...
            render: (text, record)=>(
                <Button type="ghost" data-teacher-score = {record.teacherScore} data-course-id={record.courseId}  data-course-name={record.courseName} data-student-id={record.studentId} onClick={this.showCourseTaskModalOfSingleStudent}>成果</Button>
            )
        }];
            ...
            <Row style={{minHeight:500}}>
                ...
                >
                    ...
                    <Row style={{marginTop:"20px"}} type="flex"  align="middle">
                        ...
                        <InputNumber style={{marginRight:"15px"}} onChange={this.scoreChange} value={this.state.teacherScore} />
